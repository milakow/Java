...
public class ReflectionDemo {
    ...
    public static void main(String[] args) {
        ...
        try {
            Class<?> studentClass = Class.forName("edu.sda.java.advanced.reflection.Student"); //? means some type of the class
            ...
            System.out.println("All fields of given class, but only public ones.");
