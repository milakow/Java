 ...
 *
 * Keyword "extends" indicates that we treat GasolineCar as special subtype of Car
 */
public class GasolineCar extends Car {
     ...
     * we'll use this definition of method instead of generated one
     * Overriding requires keeping same number and type of parameters, method name and return type
     *
     * As far the access (public, protected, package-private) we have to keep same access level
