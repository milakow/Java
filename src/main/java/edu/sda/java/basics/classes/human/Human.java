...
public class Human {
    ...
    String packagePrivateString = "Package private info";
     ...
     * in our case Human()
     * If we create some constructor, java does not provide us with this default one
     * We need that constructor for code to compile, we need to add it ourselves
     */
