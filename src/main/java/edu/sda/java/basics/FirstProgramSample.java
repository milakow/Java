 ...
 * 1. You name a class and a file containing the class should have some name
 * 2. EVERYTHING that works as java code must be placed inside class
 * 3. It is a rule that classes are named with capital letter
 * 4. You use capital letters for each new word in class, method or variable names
 * 5. For any block of code in Java you use {} brackets to mark it's beginning and end
 */
