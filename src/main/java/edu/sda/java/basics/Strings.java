...
public class Strings {
    public static void main(String[] args){
        ...
        System.out.println("==============================");
        String textMixed = "Some mixed Test";
...
//        String name = scanner.nextLine(); //nextLine allows program to read the whole line (because user might right few words --> so program will read everything)
        ...
        for (String letter : letters) {
            ...
            back.concat(letter); //joining letters into a word
