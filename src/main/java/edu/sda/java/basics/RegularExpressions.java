...
public class RegularExpressions {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Any upper case? : " + matcherUpperCase.find());

        Matcher matcherUpperCase2 = patternUpperCase.matcher("aDf");
        System.out.println("Any upper case? : " + matcherUpperCase2.find());

        Pattern mixed = Pattern.compile("[A-Z][A-K]\\da");
